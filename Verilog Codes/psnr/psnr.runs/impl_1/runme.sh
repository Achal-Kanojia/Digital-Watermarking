...
HD_PWD='C:/Users/student/Desktop/DS Project/psnr/psnr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log psnr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source psnr.tcl -notrace
